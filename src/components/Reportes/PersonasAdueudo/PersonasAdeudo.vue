<template>
  <div class="container is-max-desktop">
    <div class="col-12" id="Titulo">
      <h1 class="titulo_azul">Personas con adeudo</h1>
    ...
    <div class="col-12 row filtros_div" id="filtros_div">
      ...
      <div v-if="mostrarFiltros" class="pl-0 pr-0">
        <section id="data_grupo">
          <div class="row seccion_modal pt-0">
            ...
            <div class="col-12 row">
              ...
              <div class="row m-0 pb-1 pr-0 pl-0" style="">
                <div class="col-3">
                  <tipos-grado
      ...
      <div v-if="mostrarFiltros" class="filtro_footer">
        ...
        <button class="button is-primary btn-sm" @click="getBusqueda()">
          Buscar
        </button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    limpiarFiltros() {
      ...
      this.filtros.filtro_activo = "-1";
      if (this.tipo_filtro === "grupo") this.getGrupos();
